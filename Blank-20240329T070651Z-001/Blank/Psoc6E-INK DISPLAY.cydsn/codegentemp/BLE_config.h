...
#define CY_BLE_ADV_PKT_0_INDEX_SERVICE_UUID_16   (0x03u)
#define CY_BLE_SCN_PKT_0_INDEX_LOCAL_NAME   (0x00u)
#define CY_BLE_SCN_PKT_0_INDEX_TX_POWER_LEVEL   (0x13u)
#define CY_BLE_SCN_PKT_0_INDEX_APPEARANCE   (0x16u)
...
#define CY_BLE_CONFIG_GATT_DB_MAX_VALUE_LEN         (0x0011u)
...
#define CY_BLE_CONFIG_GATT_DB_ATT_VAL_COUNT         (0x08u)
