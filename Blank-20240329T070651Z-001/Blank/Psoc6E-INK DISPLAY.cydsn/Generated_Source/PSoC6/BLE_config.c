...
cy_stc_ble_gapp_disc_param_t cy_ble_discoveryParam[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        ...
        {0x10u, 0x32u, 0x00u, 0x50u, 0xA0u, 0x00u}, /* uint8_t* direct_addr */ 
...
cy_stc_ble_gapp_scan_rsp_data_t cy_ble_scanRspData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x12u, 0x09u, 0x46u, 0x69u, 0x6Eu, 0x64u, 0x20u,
        0x4Du, 0x65u, 0x20u, 0x54u, 0x61u, 0x72u, 0x67u,
        0x65u, 0x74u, 0x20u, 0x31u, 0x30u, 0x02u, 0x0Au,
        0x00u, 0x03u, 0x19u, 0x40u, 0x02u, 0x00u, 0x00u,
        0x00u, 0x00u, 0x00u }, /* uint8_t scan_rsp_data[CY_BLE_MAX_SCAN_RSP_DATA_LEN] */ 
        0x1Au, /* uint8_t scan_rsp_data_length */ 
    },
};
...
static uint8_t cy_ble_attValues[0x22u] = {
    /* Device Name */
    (uint8_t)'F', (uint8_t)'i', (uint8_t)'n', (uint8_t)'d', (uint8_t)' ', (uint8_t)'M', (uint8_t)'e', (uint8_t)' ',
(uint8_t)'T', (uint8_t)'a', (uint8_t)'r', (uint8_t)'g', (uint8_t)'e', (uint8_t)'t', (uint8_t)' ', (uint8_t)'1',
(uint8_t)'0', 
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x08u] = {
    { 0x0011u, (void *)&cy_ble_attValues[0] }, /* Device Name */
    { 0x0002u, (void *)&cy_ble_attValues[17] }, /* Appearance */
    { 0x0008u, (void *)&cy_ble_attValues[19] }, /* Peripheral Preferred Connection Parameters */
    { 0x0001u, (void *)&cy_ble_attValues[27] }, /* Central Address Resolution */
    { 0x0001u, (void *)&cy_ble_attValues[28] }, /* Resolvable Private Address Only */
    { 0x0004u, (void *)&cy_ble_attValues[29] }, /* Service Changed */
    { 0x0002u, (void *)&cy_ble_attValuesCCCD[0] }, /* Client Characteristic Configuration */
    { 0x0001u, (void *)&cy_ble_attValues[33] }, /* Alert Level */
};
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x12u] = {
    ...
    { 0x0003u, 0x2A00u /* Device Name                         */, 0x01020001u /* rd    */, 0x0003u, {{0x0011u, (void *)&cy_ble_attValuesLen[0]}} },
...
cy_stc_ble_gap_bd_addr_t cy_ble_deviceAddress = {{0x10u, 0x32u, 0x00u, 0x50u, 0xA0u, 0x00u}, 0x00u };
