...
{      
    ...
    {        
        case CY_BLE_NO_ALERT:
            ...
            Cy_GPIO_Write(NO_ALERT_0_PORT, NO_ALERT_0_NUM, LED_ON);
            Cy_GPIO_Write(Alert_LED_0_PORT, Alert_LED_0_NUM, LED_OFF);
            Cy_GPIO_Write(Alert_Midl_0_PORT, Alert_Midl_0_NUM, LED_OFF);
            break;

        case CY_BLE_MILD_ALERT:
            /* Enable MCWDT interrupt at NVIC */               
            Cy_GPIO_Write(Alert_Midl_0_PORT, Alert_Midl_0_NUM, LED_ON);
            Cy_GPIO_Write(Alert_LED_0_PORT, Alert_LED_0_NUM, LED_OFF);
            Cy_GPIO_Write(NO_ALERT_0_PORT, NO_ALERT_0_NUM, LED_OFF);
            break;
