...
cy_stc_ble_gapp_scan_rsp_data_t cy_ble_scanRspData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        ...
        0x65u, 0x74u, 0x02u, 0x0Au, 0x00u, 0x03u, 0x19u,
        0x40u, 0x02u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
        0x00u, 0x00u, 0x00u }, /* uint8_t scan_rsp_data[CY_BLE_MAX_SCAN_RSP_DATA_LEN] */ 
        0x17u, /* uint8_t scan_rsp_data_length */ 
    },
};
...
static uint8_t cy_ble_attValues[0x8Au] = {
    /* Device Name */
    (uint8_t)'F', (uint8_t)'i', (uint8_t)'n', (uint8_t)'d', (uint8_t)' ', (uint8_t)'M', (uint8_t)'e', (uint8_t)' ',
(uint8_t)'T', (uint8_t)'a', (uint8_t)'r', (uint8_t)'g', (uint8_t)'e', (uint8_t)'t', 
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Bu] = {
    ...
    { 0x0001u, (void *)&cy_ble_attValues[24] }, /* Central Address Resolution */
    { 0x0004u, (void *)&cy_ble_attValues[25] }, /* Service Changed */
    { 0x0002u, (void *)&cy_ble_attValuesCCCD[0] }, /* Client Characteristic Configuration */
    { 0x0001u, (void *)&cy_ble_attValues[29] }, /* Alert Level */
    { 0x0021u, (void *)&cy_ble_attValues[30] }, /* Manufacturer Name String */
    { 0x0020u, (void *)&cy_ble_attValues[63] }, /* Model Number String */
    { 0x0026u, (void *)&cy_ble_attValues[95] }, /* Hardware Revision String */
    { 0x0005u, (void *)&cy_ble_attValues[133] }, /* Firmware Revision String */
};
