// ======================================================================
// CE212736_PSoC6BLE_FindMe01.v generated from TopDesign.cysch
// 05/04/2025 at 20:29
...
module top ;
	...
	wire [0:0] tmpFB_0__Hibernate_Wakeup_SW_net;
	wire [0:0] tmpIO_0__Hibernate_Wakeup_SW_net;
	electrical [0:0] tmpSIOVREF__Hibernate_Wakeup_SW_net;
	...
	cy_mxs40_gpio_v1_0
		...
		Hibernate_Wakeup_SW
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Hibernate_Wakeup_SW_net[0:0]}),
		  .io({tmpIO_0__Hibernate_Wakeup_SW_net[0:0]}),
		  .siovref(tmpSIOVREF__Hibernate_Wakeup_SW_net),
		  .annotation({Net_72}));
    ...
    cy_annotation_universal_v1_0 P6_VDD_3 (
        .connect({
            Net_73
        })
    );
    defparam P6_VDD_3.comp_name = "Power_v1_0";
    defparam P6_VDD_3.port_names = "T1";
    defparam P6_VDD_3.width = 1;
